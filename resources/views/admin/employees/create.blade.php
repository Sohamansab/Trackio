            ...
            <form action="{{ route('admin.employees.store') }}" method="POST">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-select" id="designation_id" name="designation_id" required>
                            ...
                            @foreach($designations as $desig)
                                <option value="{{ $desig->designation_id }}" {{ old('designation_id') == $desig->designation_id ? 'selected' : '' }}>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <small class="text-muted">This will create a user account for the employee</small>
                    </div>
