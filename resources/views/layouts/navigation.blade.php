            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user()->role == 1)
                        ...
                        <x-nav-link :href="route('admin.designations.index')" :active="request()->routeIs('admin.designations.*')">
                            {{ __('Designations') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->role == 1)
                ...
                <x-responsive-nav-link :href="route('admin.designations.index')" :active="request()->routeIs('admin.designations.*')">
                    {{ __('Designations') }}
                </x-responsive-nav-link>
